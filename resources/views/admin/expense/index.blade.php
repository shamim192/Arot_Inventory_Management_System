    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li {{ (isset($list)) ? 'class=active' : '' }}>
                <a href="{{ route('expense.index').qString() }}">
                    <i class="fa fa-list" aria-hidden="true"></i> Expense {{ __('lang.List') }}
                </a>
            </li>

            <li {{ (isset($create)) ? 'class=active' : '' }}>
                <a href="{{ route('expense.create').qString() }}">
                    <i class="fa fa-plus" aria-hidden="true"></i> {{ __('lang.Add') }} Expense
                </a>
            </li>
            ...
            <li class="active">
                <a href="#">
                    <i class="fa fa-edit" aria-hidden="true"></i> {{ __('lang.Edit') }} Expense
                </a>
            </li>
            @endif
            ...
            <li class="active">
                <a href="#">
                    <i class="fa fa-list-alt" aria-hidden="true"></i> Expense  {{ __('lang.Details') }}
                </a>
            </li>
            @endif
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active">
                <div class="box-body table-responsive">
                    <table class="table table-bordered">
                        <tr>
                            <th style="width:120px;">Expense No.</th>
            ...
            <div class="tab-pane active">
                <div class="box-body">
                    <form method="POST" action="{{ isset($edit) ? route('expense.update', $edit) : route('expense.store') }}{{ qString() }}" id="are_you_sure" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" placeholder="Auto Generate" name="expense_number" id="expense_number" disabled>
                                    </div>
                                </div>
            ...
            @elseif (isset($list))
            <div class="tab-pane active">
                <form method="GET" action="{{ route('expense.index') }}" class="form-inline">
                    <div class="box-header text-right">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-warning btn-flat" href="{{ route('expense.index') }}">X</a>
                            </div>
                        </div>
                    </div>
                </form>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="{{ route('expense.show', $val->id).qString() }}"><i class="fa fa-eye"></i> Show</a></li>
                                            <li><a href="{{ route('expense.edit', $val->id).qString() }}"><i class="fa fa-eye"></i> Edit</a></li>
                                            <li><a onclick="deleted('{{ route('expense.destroy', $val->id).qString() }}')"><i class="fa fa-close"></i> Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
...
<script>
    function addRow(key) {
        ...
        var html = `<tr id="row` + newKey + `">
            <input type="hidden" name="expense_data_id[]" value="0">
