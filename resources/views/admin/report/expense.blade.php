    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <form method="GET" action="{{ route('report.expense') }}" class="form-inline">
                    <div class="box-header text-right">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-warning btn-flat" href="{{ route('report.expense') }}">X</a>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                {{-- <td>{{ $val->BankName }}</a></td> --}}
                                {{-- <td><a href="{{ route('report.expense-transactions').'?expense='.$val->id }}">{{ $val->ExpenseName }} </a></td> --}}
                                <td><a href="{{ route('report.expense-transactions', ['category' => $val->Expense_id]) }}">{{ $val->ExpenseName }}</a></td>

                                <td>{{ $val->ExpenseCode }}</td>
                                <td>{{ $val->ExpenseDate }}</td>
                                
                                <td style="text-align: right;">{{ $val->ExpenseAmount }} {{ env('CURRENCY') }}</td>
                            </tr>
                            @endforeach
                        </tbody>
