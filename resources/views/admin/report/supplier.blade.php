    ...
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <div class="tab-pane active">
                <form method="GET" action="{{ route('report.supplier') }}" class="form-inline">
                    <div class="box-header text-right">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-warning btn-flat" href="{{ route('report.supplier') }}">X</a>
                            </div>
                        </div>
                    </div>
                </form>
                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Mobile</th>
                                <th>Shop Name</th>
                                {{-- <th style="text-align: right;">StockIn Amount</th>
                                <th style="text-align: right;">Stock Return Amount</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="{{ route('report.supplier-transactions').'?supplier='.$val->id }}">{{ $val->name }}</a></td>
                                <td>{{ $val->mobile }}</td>
                                <td>{{ $val->shop_name }}</td>
                                {{-- <td style="text-align: right;">{{ $val->stockAmount }} {{ env('CURRENCY') }}</td>
