    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li {{ (isset($list)) ? 'class=active' : '' }}>
                <a href="{{ route('customer.index').qString() }}">
                    <i class="fa fa-list" aria-hidden="true"></i> Customer {{ __('lang.List') }}
                </a>
            </li>

            <li {{ (isset($create)) ? 'class=active' : '' }}>
                <a href="{{ route('customer.create').qString() }}">
                    <i class="fa fa-plus" aria-hidden="true"></i> {{ __('lang.Add') }} Customer
                </a>
            </li>
            ...
            <li class="active">
                <a href="#">
                    <i class="fa fa-edit" aria-hidden="true"></i> {{ __('lang.Edit') }} Customer
                </a>
            </li>
            @endif
            ...
            <li class="active">
                <a href="#">
                    <i class="fa fa-list-alt" aria-hidden="true"></i> Customer  {{ __('lang.Details') }}
                </a>
            </li>
            @endif
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active">
                <div class="box-body">
                    <form method="POST" action="{{ isset($edit) ? route('customer.update', $edit) : route('customer.store') }}{{ qString() }}" id="are_you_sure" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
            ...
            <div class="tab-pane active">
                    ...
                    <div class="box-header text-right">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-warning btn-flat" href="{{ route('customer.index') }}">X</a>
                            </div>
                        </div>
                    </div>
                </form>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="{{ route('customer.show', $val->id).qString() }}"><i class="fa fa-eye"></i> Show</a></li>
                                            <li><a href="{{ route('customer.edit', $val->id).qString() }}"><i class="fa fa-eye"></i> Edit</a></li>
                                            <li><a onclick="deleted('{{ route('customer.destroy', $val->id).qString() }}')"><i class="fa fa-close"></i> Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="row">
                    <div class="col-sm-4 pagi-msg">{!! pagiMsg($customers) !!}</div>
