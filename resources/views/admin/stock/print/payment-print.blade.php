...
<div style="width: 80mm; margin:0 auto; font-family: Arial;">
    <table border="0" cellpadding="0" cellspacing="0" style="width:100%; border-collapse: collapse;">
        <tr>
            <td>{!! printHeader('সাপ্লায়ার পেমেন্ট রসিদ') !!}</td>
        </tr>
        <tr>
    ...
    <table border="0" cellpadding="2" cellspacing="0" style="width:100%; border-collapse: collapse; font-size:14px;">
        <tbody>
            ...
            <tr>
                ...
                <td style="font-weight: normal; text-align: right;">{{ $data->supplier != null ? $data->supplier->name : 'N/A' }}</td>
            </tr>
            <tr>
                <td style="font-weight: normal;">মোবাইলঃ</td>
                <td style="font-weight: normal; text-align: right;">{{ $data->supplier != null ? enToBnNumber($data->supplier->mobile) : '-' }}</td>
            </tr>
        </tbody>

        <tfoot>
            <tr>
                <td style="border-top: 1px dashed #000; height:5px;" colspan="2"></td>
            </tr>
            <tr>
                <td style="font-weight: 600; font-size: 14px;">মোট</td>
            ...
            <tr>
                <td colspan="2" class="noprint" style="text-align: center;"><br><br><a href="{{ route('supplier-payment.index') }}">BACK TO LIST</a></td>
            </tr>
        </tfoot>
    </table>
</div>
