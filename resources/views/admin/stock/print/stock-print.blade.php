...
<div style="width: 80mm; margin:0 auto; font-family: Arial;">
    <table border="0" cellpadding="0" cellspacing="0" style="width:100%; border-collapse: collapse;">
        ...
        <tr>
            <td style="font-size:14px;">
                ...
                নামঃ {{ $data->supplier != null ? $data->supplier->name : 'N/A'}}<br>
                মোবাইলঃ {{ $data->supplier != null ? enToBnNumber($data->supplier->mobile) : '-'}}
            </td>
        </tr>
        <tr>
    ...
    <table border="0" cellpadding="2" cellspacing="0" style="width:100%; border-collapse: collapse; font-size:12px;">
        ...
        <tfoot>
            ...
            <tr>
                <td style="font-weight: 600; font-size:14px;" colspan="3"><strong>ট্যাক্সঃ({{ enToBnNumber($data->tax_percent) }}%)</strong></td>
                <td style="font-weight: 600; font-size:14px; text-align: right;">{{ enToBnNumber($data->tax_amount) }}{{ env('CURRENCY') }}</td>
            </tr>
            @endif
            ...
            <tr>
                ...
                <td style="font-weight: 600; font-size:14px; text-align: right;">{{ enToBnNumber($data->discount_amount) }}{{ env('CURRENCY') }}</td>
            </tr>
            @endif
            ...
            @if($data->tax_amount > 0 || $data->discount_amount > 0)
            <tr>
            ...
            <tr>
                <td colspan="4" class="noprint" style="text-align: center;"><br><br><a href="{{ route('stock.index') }}">BACK TO LIST</a></td>
            </tr>
        </tfoot>
    </table>
</div>
