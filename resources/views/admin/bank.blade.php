    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li {{ (isset($list)) ? 'class=active' : '' }}>
                <a href="{{ route('bank.index').qString() }}">
                    <i class="fa fa-list" aria-hidden="true"></i> Bank {{ __('lang.List') }}
                </a>
            </li>

            <li {{ (isset($create)) ? 'class=active' : '' }}>
                <a href="{{ route('bank.create').qString() }}">
                    <i class="fa fa-plus" aria-hidden="true"></i> {{ __('lang.Add') }} Bank
                </a>
            </li>
            ...
            <li class="active">
                <a href="#">
                    <i class="fa fa-edit" aria-hidden="true"></i> {{ __('lang.Edit') }} Bank
                </a>
            </li>
            @endif
            ...
            <li class="active">
                <a href="#">
                    <i class="fa fa-list-alt" aria-hidden="true"></i> Bank  {{ __('lang.Details') }}
                </a>
            </li>
            @endif
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active">
                <div class="box-body">
                    <form method="POST" action="{{ isset($edit) ? route('bank.update', $edit) : route('bank.store') }}{{ qString() }}" id="are_you_sure" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <div class="form-group{{ $errors->has('branch') ? ' has-error' : '' }}">
                                    <label class="control-label col-sm-3 required">Branch:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="branch" value="{{ old('branch', isset($data) ? $data->branch : '') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('account_number') ? ' has-error' : '' }}">
                                    <label class="control-label col-sm-3 required">Account Number:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="account_number" value="{{ old('account_number', isset($data) ? $data->account_number : '') }}" required>
            ...
            @elseif (isset($list))
            <div class="tab-pane active">
                <form method="GET" action="{{ route('bank.index') }}" class="form-inline">
                    <div class="box-header text-right">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-warning btn-flat" href="{{ route('bank.index') }}">X</a>
                            </div>
                        </div>
                    </div>
                </form>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="{{ route('bank.show', $val->id).qString() }}"><i class="fa fa-eye"></i> Show</a></li>
                                            <li><a href="{{ route('bank.edit', $val->id).qString() }}"><i class="fa fa-eye"></i> Edit</a></li>
                                            <li><a onclick="deleted('{{ route('bank.destroy', $val->id).qString() }}')"><i class="fa fa-close"></i> Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
